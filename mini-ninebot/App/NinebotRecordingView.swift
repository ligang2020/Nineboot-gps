    ...
    var body: some View {
        HStack(alignment: .top) {
            VStack(alignment: .leading, spacing: 5) {
                Text(snapshot?.vehicle.displayName ?? "暂无车辆")
...
private struct RecordedRideDetailMetrics: View {
    ...
    var body: some View {
        LazyVGrid(
            ...
            RecordingDetailMetric(title: "最高速度", value: formatRecordingSpeed(record.maxSpeedKmh), systemImage: "gauge.with.dots.needle.67percent", tint: .yellow)
