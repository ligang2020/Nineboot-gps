    ...
    var body: some View {
        ZStack {
            ...
            VStack(alignment: .leading, spacing: 13) {
                ...
                RideActivityProgress(value: Double(state.battery ?? 0) / 100)
                    .frame(height: 6)
                ...
                HStack(spacing: 0) {
                    ...
                    RideActivityMetric(value: rideUpdatedText(state.updatedAt), title: "更新", icon: "clock.fill")
                }
            }
            .padding(16)
        }
...
private struct RideIslandMetrics: View {
    ...
    var body: some View {
        HStack(spacing: 0) {
            ...
            RideIslandMetric(value: rideUsedElectricityText(state), title: "用电")
...
@available(iOS 16.1, *)
private struct RideActivityProgress: View {
    var value: Double
        ...
        GeometryReader { proxy in
            ZStack(alignment: .leading) {
                ...
                Capsule()
                    ...
                    .frame(width: max(proxy.size.width * min(max(value, 0), 1), 7))
            }
        }
    }
}
